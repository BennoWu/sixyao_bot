...
if __name__ == '__main__':
	...
	# 	dateData = fourPillarToDateMain(  buf.replace( "/", ",") )
	# 	print( "DD - ",dateData )
	sixYaoMain( "+63,134,114 // 占我的藍牙耳機在那裏?",showPic = True)
	...
	# print("101110,2:", checkAllGua("101110,2", checkMode=True))	
	...
	# sixYaoMain( "乙巳年寅月丁酉日//110010,1",showPic = False )
	...
	# sixYaoMain( "女性朋友占感情//  011100,2", showPic = True )
# 110$0$
